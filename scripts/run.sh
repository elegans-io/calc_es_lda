...
date
spark-submit --class ${CLASS_NAME} --jars ${HOME}/.ivy2/cache/com.github.scopt/scopt_2.11/jars/scopt_2.11-3.5.0.jar,${HOME}/.ivy2/cache/edu.stanford.nlp/stanford-corenlp/jars/stanford-corenlp-3.6.0-models.jar,${HOME}/.ivy2/cache/edu.stanford.nlp/stanford-corenlp/jars/stanford-corenlp-3.6.0.jar,${HOME}/.ivy2/cache/org.elasticsearch/elasticsearch-spark_2.11/jars/elasticsearch-spark_2.11-2.4.0.jar,${HOME}/.ivy2/cache/org.apache.spark/spark-mllib_2.11/jars/spark-mllib_2.11-2.0.0.jar ${BUILD_PATH}/target/scala-2.11/clustering_2.11-0.1.jar $@
date
